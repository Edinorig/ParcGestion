...
class FloraElement {
    constructor(parentElement) {
        ...
        const templateString = '<div class="line-block-flora"> <p class="line-Text-ambiente"></p><p class="line-Text-nome"></p><p class="line-Text-quantity"></p><p class="line-Text-age"></p><p class="line-Text-sex"></p><p class="line-Text-kind"></p><p class="line-Text-health"></p><p class="line-Text-type"></p><p class="line-Text-birthday"></p><p class="line-Text-dataRegistered"></p></div>';
    ...
    initElements() {
        this.elements = {
            ...
            blockFlora: this.template.querySelector('.wrapper-list-flora'),
